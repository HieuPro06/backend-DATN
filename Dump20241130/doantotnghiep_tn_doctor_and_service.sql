...
DROP TABLE IF EXISTS `tn_doctor_and_service`;
...
LOCK TABLES `tn_doctor_and_service` WRITE;
/*!40000 ALTER TABLE `tn_doctor_and_service` DISABLE KEYS */;
/*!40000 ALTER TABLE `tn_doctor_and_service` ENABLE KEYS */;
UNLOCK TABLES;
