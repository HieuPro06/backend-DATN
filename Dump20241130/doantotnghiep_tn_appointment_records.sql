...
DROP TABLE IF EXISTS `tn_appointment_records`;
...
LOCK TABLES `tn_appointment_records` WRITE;
/*!40000 ALTER TABLE `tn_appointment_records` DISABLE KEYS */;
INSERT INTO `tn_appointment_records` VALUES (1,1,'Đau răng','Đau răng số 8','Bình thường','Nhổ răng',NULL,'2024-11-23 14:39:58');
/*!40000 ALTER TABLE `tn_appointment_records` ENABLE KEYS */;
UNLOCK TABLES;
