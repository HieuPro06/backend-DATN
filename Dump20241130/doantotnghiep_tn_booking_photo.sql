...
DROP TABLE IF EXISTS `tn_booking_photo`;
...
LOCK TABLES `tn_booking_photo` WRITE;
/*!40000 ALTER TABLE `tn_booking_photo` DISABLE KEYS */;
/*!40000 ALTER TABLE `tn_booking_photo` ENABLE KEYS */;
UNLOCK TABLES;
