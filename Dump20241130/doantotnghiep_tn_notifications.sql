...
DROP TABLE IF EXISTS `tn_notifications`;
...
LOCK TABLES `tn_notifications` WRITE;
/*!40000 ALTER TABLE `tn_notifications` DISABLE KEYS */;
/*!40000 ALTER TABLE `tn_notifications` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-11-30 15:19:20
